    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ETUDIANT', 'Étudiant'), ('ADMIN', 'Administrateur'), ('CHEF_SERVICE', 'Chef Service Restaurant'), ('MAGASINIER', 'Magasinier'), ('VENDEUR_TICKETS', 'Vendeur Tickets'), ('RESPONSABLE_GUICHET', 'Responsable Guichet'), ('CUISINIER', 'Cuisinier')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(db_column='id', primary_key=True, serialize=False)),
                ('nomPeriode', models.CharField(db_column='nomPeriode', max_length=20)),
            ],
            options={
                'db_table': 'periode',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('utilisateur', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)ss', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(help_text='Date de la réservation (détermine la semaine ciblée)')),
                ...
                ('initiateur', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reservations_initiees', to=settings.AUTH_USER_MODEL)),
                ('jour', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='reservations', to='monapp.jour')),
                ('periode', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='reservations', to='monapp.periode')),
                ('reservant_pour', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='reservations_beneficiees', to='monapp.etudiant')),
            ],
            options={
