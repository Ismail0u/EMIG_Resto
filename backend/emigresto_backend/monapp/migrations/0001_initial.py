# Generated by Django 5.2.1 on 2025-06-26 09:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('periode', models.ForeignKey(help_text='Période de la réservation (Petit-déjeuner, Déjeuner, DINER)', on_delete=django.db.models.deletion.PROTECT, related_name='reservations', to='monapp.periode')),
