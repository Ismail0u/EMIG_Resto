# Generated by Django 5.2.1 on 2025-06-20 00:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statut', models.CharField(choices=[('VALIDE', 'Valide'), ('ANNULE', 'Annulée'), ('EXPIRED', 'Expirée')], default='VALIDE', max_length=10)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('jour', models.ForeignKey(help_text='Le jour de la semaine pour la réservation', on_delete=django.db.models.deletion.CASCADE, related_name='reservations', to='monapp.jour')),
                ('periode', models.ForeignKey(help_text='La période (petit-déj, déjeuner, dîner) de la réservation', on_delete=django.db.models.deletion.CASCADE, related_name='reservations', to='monapp.periode')),
            ...
            options={
                ...
                'ordering': ['date', 'periode__nomPeriode', 'jour__id'],
